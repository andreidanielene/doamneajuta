...
/**
 * <p>Java class for goalsHomeTeamType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="goalsHomeTeamType">
 *   &lt;simpleContent>
...
@XmlType(name = "goalsHomeTeamType", propOrder = {
    "value"
})
public class GoalsHomeTeamType
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GoalsHomeTeamType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GoalsHomeTeamType that = ((GoalsHomeTeamType) object);
        {
            String lhsValue;
